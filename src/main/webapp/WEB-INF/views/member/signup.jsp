	...
	$(document)
			.ready(
					function() {
						...
						// 닉네임 중복 체크 버튼 클릭시
						$("#checkNickNameButton1")
								.click(
										function(e) {
											e.preventDefault();
											$("#checkNickNameButton1").attr(
													"disabled", "");
						...
						// 패스워드 오타 확인
						$("#passwordInput1, #passwordInput2").keyup(
								function() {
				...
				<form id="form1" action="${appRoot }/member/signup" method="post">
					...
					<div class="form-group">
						...
						<div class="input-group-append">
							<input class="form-control" type="password" id="passwordInput1"
								type="text" name="password" autocomplete="false"
								placeholder="비밀번호를 입력해주세요." />
						</div>
					</div>

					<label for="passwordInput2" class="form-label"> 비밀번호 재확인 </label>
					<input class="form-control" id="passwordInput2" type="password"
					...
					<div class="form-group">
						<button class="btn signupbtn" id="signupbtn" disabled>회원가입</button>
						<a class="btn bkbtn" style="float: right;" type="button"
							href="${appRoot}/main/home">취소</a>
					</div>
