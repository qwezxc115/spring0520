		...
		<div class="row justify-content-center">
			<div class="col-12 col-lg-6">
				...
				<div>
					...
					<input id="idInput1" class="form-control" type="text"
					...
					<div class="input-group">
						<input class="form-control" id="emailInput1" type="email"
							value="${member.email }" />
						<button class="btn btn-secondary" id="emailCheckButton1" disabled>이메일 중복확인</button>
					</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form1" action="${appRoot }/member/remove" method="post">
						...
						<input class="form-control" id="passwordInput3" type="text"
							name="password" />
					</form>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="form2" action="${appRoot }/member/modify" method="post">
						...
						<label for="passwordInput4" class="form-label"> 기존 암호 </label>

						<input class="form-control" id="passwordInput4" type="text"
							name="oldPassword" />
					</form>
				</div>
				<div class="modal-footer">
